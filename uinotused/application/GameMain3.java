...
//	
	...
	static {
		try {
			...
			player.numtimeselka.put(0, 1);
			player.numtimeselka.put(1, 1);
			player.numtimeselka.put(2, 1);
			player.numtimeselka.put(3, 1);

			
			player.numtimeselkb.put(0, 1);
			player.numtimeselkb.put(1, 1);
			player.numtimeselkb.put(2, 1);
			player.numtimeselkb.put(3, 1);
...
// gonna add the nature token thing here 
			...
			//engame
			Button endgame = (Button) root.lookup("#endgame");
			
			endgame.setOnAction(event -> {
			    Stage stage = (Stage) endgame.getScene().getWindow();
			    stage.close();

			    score1  = player.HawkScoringA(wildlifetokenplaced, player.CurrentPlayer)+player.ElkScoring(wildlifetokenplaced, score1)+player.foxScoring(wildlifetokenplaced)+player.salmonScoring(wildlifetokenplaced)+player.NatureTokens.get(player.CurrentPlayer);
				if(player.playercount > 3) { 
			    score3 =  player.HawkScoringA(wildlifetokenplaced, player.CurrentPlayer +2)+player.ElkScoring(wildlifetokenplaced, score1)+player.foxScoring(wildlifetokenplaced)+player.salmonScoring(wildlifetokenplaced)+player.NatureTokens.get(player.CurrentPlayer +1);
				    score4 =  player.HawkScoringA(wildlifetokenplaced, player.CurrentPlayer +3)+player.ElkScoring(wildlifetokenplaced, score1)+player.foxScoring(wildlifetokenplaced)+player.salmonScoring(wildlifetokenplaced)+player.NatureTokens.get(player.CurrentPlayer +3);
			    ...
			    score2 =  player.HawkScoringA(wildlifetokenplaced, player.CurrentPlayer +1)+player.ElkScoring(wildlifetokenplaced, score1)+player.foxScoring(wildlifetokenplaced)+player.salmonScoring(wildlifetokenplaced)+player.NatureTokens.get(player.CurrentPlayer +1);
			    System.out.println("FINAL SCORE");

			    System.out.println(player.getName(0)+" Score:"+score1);
			    System.out.println(player.getName(1)+" Score:"+score2);
if(player.playercount==4) {
	System.out.println(player.getName(2)+" Score:"+score3);
    System.out.println(player.getName(3)+" Score:"+score4);
}
if(player.playercount==3) {
	System.out.println(player.getName(2)+" Score:"+score3);
}
...
if(count == 20) {
	 Stage stage = (Stage) endgame.getScene().getWindow();
	    ...
	    System.out.println(player.getName(player.CurrentPlayer)+" Score:"+score1);
}
			if(player.playercount > 3) {
				 player.CurrentPlayer = 3;
					Stage stage = (Stage) button.getScene().getWindow();
					stage.setScene(GameMain4.getScene());
					stage.show();
			}
			else { player.CurrentPlayer = 0;
				Stage stage = (Stage) button.getScene().getWindow();
