		...
		try {
			...
			root = loader.load();
			 Board board = new Board(8, 7, 60);
		        Rectangle[][] rectangles = board.getRectangles();			//ptileBoard.tileBoard[0][0].rectangles.setFill(java.awt.Color.BLACK); example of how to access rectangle and change its color
