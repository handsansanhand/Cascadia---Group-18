...
//	
	...
	static {
		try {
			...
			for (int i = 0; i < 10; i++) {
				labelList.add(new Text(wildlifetokenholder));
			}
...
//rec 3 clicked 
			...
			rec3.setOnMouseClicked(event -> {
				...
				rectangles[2][0].setOnMouseClicked(e -> {
					if (player.isValidClick(2, 0, rectangles) == true) {						naturetoken.setVisible(false);
...
// rec 4 clicked 
			...
			rec4.setOnMouseClicked(event -> {
				...
				rectangles[3][0].setOnMouseClicked(e -> {
					if (player.isValidClick(3, 0, rectangles) == true) {						naturetoken.setVisible(false);
					naturetoken.setVisible(false);
				...
				rectangles[5][4].setOnMouseClicked(e -> {
					if (player.isValidClick(5, 4, rectangles) == true) {						naturetoken.setVisible(false);
					naturetoken.setVisible(false);
...
if(player.getplayercount() == 3) {
	...
	stage.show();
				...
				System.out.print("\n"+player.Wildlifecounter(wildlifetokenplaced)+"\n");

				for (Text textggg : wildlifetokenplaced) {
					if (textggg.getText() == "") {

					} else {
						System.out.print(textggg.getText() + " ");
					}
				}
